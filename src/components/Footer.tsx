...
const Footer = () => {
  return (
    <footer className="py-10 bg-resume-gray-dark text-white">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <FileText className="h-6 w-6 text-resume-blue-light" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-resume-gray-light">
        ...
        <div className="mt-10 pt-6 border-t border-resume-gray flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-resume-gray-light text-sm">
            © {new Date().getFullYear()} ResumeAI. All rights reserved.
          </p>
          <div className="flex space-x-4">
            <a href="#" className="text-resume-gray-light hover:text-white transition-colors">
