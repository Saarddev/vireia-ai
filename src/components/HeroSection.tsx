      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center space-y-6">
            <div className="inline-flex items-center rounded-full bg-resume-purple/10 px-3 py-1 text-sm text-resume-purple max-w-fit animate-slide-up">
              <Sparkles className="mr-1 h-3 w-3" />
              <span>AI-Powered Resume Builder</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl leading-tight animate-slide-up animate-delay-100">
            ...
            <p className="max-w-[600px] text-resume-gray-dark md:text-xl animate-slide-up animate-delay-200">
            ...
            <div className="flex flex-col gap-3 min-[400px]:flex-row animate-slide-up animate-delay-300">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm pt-2 animate-slide-up animate-delay-400">
          ...
          <div className="flex items-center justify-center animate-scale-up animate-delay-500">
            <div className="relative w-full max-w-[500px]">
              <div className="rounded-xl border bg-white shadow-xl p-6 relative z-10 backdrop-blur-sm bg-white/70 hover:scale-105 transition-transform duration-500">
              ...
              <div className="absolute -bottom-6 -right-6 w-[90%] h-[90%] rounded-xl bg-gradient-to-br from-resume-purple/20 to-resume-violet/20 z-0 animate-float"></div>
