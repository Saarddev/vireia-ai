...
const Navbar = () => {
  return (
    <nav className="py-4 border-b backdrop-blur-md bg-white/80 sticky top-0 z-50 animate-fade-in">
      <div className="container flex items-center justify-between">
        ...
        <div className="flex space-x-3 animate-slide-in-right">
          ...
          <Button className="bg-resume-purple hover:bg-resume-purple-dark shadow-lg shadow-resume-purple/20 transition-all duration-300 hover:shadow-xl hover:shadow-resume-purple/30">Get Started</Button>
